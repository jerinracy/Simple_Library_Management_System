...
class MemberForm extends JFrame{
	...
	MemberForm(){
		this.setTitle("Member Registration Form");
		...
		this.add(panel);
		LBAction lba = new LBAction();
		btn.addActionListener(lba);
	}
	public class LBAction implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			else
			{
				if(String.valueOf(pf1.getPassword()).equals(String.valueOf(pf2.getPassword())))
				{
					...
					l.AddMember(tf1.getText(),tf2.getText(),age,tf4.getText(),tf5.getText(),String.valueOf(pf1.getPassword()));
					MemberForm.this.dispose();
				}
				else
				{
