	...
	public NAPanel(){
		...
		this.addWindowListener(new WindowAdapter(){
			public void windowClosing(WindowEvent e){
				...
				{
					NAPanel.this.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
				}
			}
		});
			...
			public void actionPerformed(ActionEvent e){
				...
				else
				{
					try{
						...
						Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/admin","root","");
						Statement stmt = con.createStatement();
						ResultSet rs = stmt.executeQuery("SELECT `name`,`id`,`age`,`location`,`username` FROM `info` WHERE `username` ="+"'"+Login.txt1.getText()+"'");
						rs.next();
						name = rs.getString(1);
						id = rs.getString(2);
						age = rs.getInt(3);
					...
					button2.addActionListener(new ActionListener(){
						public void actionPerformed(ActionEvent e){
							...
							frame.setTitle("Admin Profile Update Form");
							...
							btn.addActionListener(new ActionListener(){
								public void actionPerformed(ActionEvent e){
									...
									else
									{
										...
										{
											Admin aa = new Admin();
											aa.updateInfo(tf1.getText(),tf2.getText(),tf3.getText(),tf4.getText(),String.valueOf(Login.txt1.getText()),String.valueOf(pf1.getPassword()));
