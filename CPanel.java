...
class CPanel extends JFrame{
	...
	public CPanel(){
		...
		btn2 = new JButton("Delete Book");
		btn2.setBounds(120,100,150,50);
		
		btn3 = new JButton("View All Books");
		btn3.setBounds(120,170,150,50);
		
		btn4 =new JButton("Search Book");
		...
		btn2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				else
				{
					...
					tmp.DeleteBook(temp);
					JOptionPane.showMessageDialog(null,temp+" is Deleted Successfully ");
				}
			}
			...
			public void actionPerformed(ActionEvent e){
				...
				else
				{
					try{
						...
						Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/admin","root","");
						Statement stmt = con.createStatement();
						ResultSet rs = stmt.executeQuery("SELECT `name`,`id`,`age`,`location`,`username` FROM `clark` WHERE `username` ="+"'"+Login.txt1.getText()+"'");
						rs.next();
						name = rs.getString(1);
						id = rs.getString(2);
						age = rs.getInt(3);
					...
					button2.addActionListener(new ActionListener(){
						public void actionPerformed(ActionEvent e){
							...
							frame.setTitle("Clark Profile Update Form");
							...
							btn.addActionListener(new ActionListener(){
								public void actionPerformed(ActionEvent e){
									...
									else
									{
										...
										{
											Clark cc = new Clark();
											cc.updateInfo(tf1.getText(),tf2.getText(),tf3.getText(),tf4.getText(),String.valueOf(Login.txt1.getText()),String.valueOf(pf1.getPassword()));
		...
		this.addWindowListener(new WindowAdapter(){
			public void windowClosing(WindowEvent e){
				...
				{
					CPanel.this.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
				}
			}
		});
	}
