...
class LPanel extends JFrame{
	...
	public LPanel(){
		...
		btn1 = new JButton("Add Member");
		btn1.setBounds(120,30,150,50);
		
		btn2 = new JButton("Delete Member");
		btn2.setBounds(120,100,150,50);
		
		btn3 = new JButton("View Member Info");
		btn3.setBounds(120,170,150,50);
		
		btn4 =new JButton("Add Book");
		btn4.setBounds(120,240,150,50);
		
		btn5 =new JButton("Remove Book");
		btn5.setBounds(120,310,150,50);
		
		btn6 =new JButton("Show All Book");
		btn6.setBounds(120,380,150,50);
		
		btn7 =new JButton("Search Book");
		btn7.setBounds(120,450,150,50);
		
		btn8 = new JButton("Profile");
		btn8.setBounds(120,520,150,50);
		...
		btn2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				String temp = JOptionPane.showInputDialog("Input Member Name");
				if(temp.equals(""))
				{
					JOptionPane.showMessageDialog(null,"No Name is inputed");
				}
				else
				{
					Librarian tmp = new Librarian();
					tmp.DeleteMember(temp);
				}
			}
		});
		...
		btn5.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				String temp = JOptionPane.showInputDialog("Input Book Name");
				if(temp.equals(""))
				{
					JOptionPane.showMessageDialog(null,"No Name is inputed");
				}
		...
		btn3.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				String [] columns = new String[] {"name", "id", "age","location"};
		...
		btn7.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				frmm.getContentPane().add(scroll);
				frmm.pack();
		...
		btn8.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				frm.setTitle("Librarian Profile");
				frm.setSize(400,550);
				...
				Librarian tmp = new Librarian();
				tmp.checkpass(Login.txt1.getText());
				...
				else
				{
					try{
						...
						Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/admin","root","");
						Statement stmt = con.createStatement();
						ResultSet rs = stmt.executeQuery("SELECT `name`,`id`,`age`,`location`,`username` FROM `librarian` WHERE `username` ="+"'"+Login.txt1.getText()+"'");
						rs.next();
						name = rs.getString(1);
						id = rs.getString(2);
						age = rs.getInt(3);
					...
					button2.addActionListener(new ActionListener(){
						public void actionPerformed(ActionEvent e){
							...
							frame.setTitle("Librarian Registration Form");
								...
								public void actionPerformed(ActionEvent e){
									...
									else
									{
										if(String.valueOf(pf1.getPassword()).equals(String.valueOf(pf2.getPassword())))
										{
											...
											ll.updateInfo(tf1.getText(),tf2.getText(),tf3.getText(),tf4.getText(),String.valueOf(Login.txt1.getText()),String.valueOf(pf1.getPassword()));
		...
		this.addWindowListener(new WindowAdapter(){
			public void windowClosing(WindowEvent e){
				...
				{
					LPanel.this.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
				}
			}
		});
	}
